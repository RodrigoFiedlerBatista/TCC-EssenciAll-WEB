      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li class="scroll"><a href="GerenciaLogin">Sair</a></li> 
          </ul>
        </div>
      </div>
    </div><!--/#main-nav-->
    ...
    <div id="contact-us" class="parallax">
      <div class="container">
        <div class="row">
          <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            <h2>Contate-nos</h2>
            <p> A comunicação é essencial para tudo ocorrer bem. Duvidas ou sugestões? fale conosco!!</p>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <form id="main-contact-form" name="contact-form" method="post" action="#">
                ...
                <div class="form-group">
                  <textarea name="message" id="message" class="form-control" rows="4" placeholder="Digite aqui sua mensagem" required="required"></textarea>
                </div>                        
                <div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                <p>Demais informações seguem abaixo.</p>
                <ul class="address">
                  <li><i class="fa fa-map-marker"></i> <span> Address:</span> 2400 South Avenue A </li>
                  <li><i class="fa fa-phone"></i> <span> Telefone:</span> +928 336 2000  </li>
